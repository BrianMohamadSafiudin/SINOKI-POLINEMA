            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body pl-4">
                        ...
                        <a href="{{ route('tambahTugas', ['data' => $data]) }}" class=" d-sm-inline-block btn btn-success btn-sm shadow-sm mt-2 mb-4 ">
                            <i class="fas fa-sm text-white-50"></i>Tambah Tugas
                        </a>
                        <a href="{{ route('halamanDataSie', ['data' => $data]) }}" class=" d-sm-inline-block btn btn-primary btn-sm shadow-sm ml-2 mt-2 mb-4">
